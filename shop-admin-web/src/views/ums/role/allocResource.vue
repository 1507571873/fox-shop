...
<script>
    import {queryResourceDataAll} from '@/api/ums/resource/resource'
    import {queryResourceCategoryAll} from "@/api/ums/resource/resourceCategory";
    import {queryRoleOrResourceData,saveData} from "@/api/ums/roleOrResource/roleOrResource"
  ...
  export default {
    ...
    methods: {
      getAllResourceList() {
        queryResourceDataAll().then(response => {
      ...
      getAllResourceCateList() {
        queryResourceCategoryAll().then(response => {
      ...
      getResourceByRole(roleId){
        queryRoleOrResourceData(roleId).then(response=>{
